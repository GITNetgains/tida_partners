...
FetchSlotsResponseModel fetchSlotsResponseModelFromJson(String str) => FetchSlotsResponseModel.fromJson(json.decode(str));

String fetchSlotsResponseModelToJson(FetchSlotsResponseModel data) => json.encode(data.toJson());
...
class FetchSlotsResponseModel {
    ...
    factory FetchSlotsResponseModel.fromJson(Map<String, dynamic> json) => FetchSlotsResponseModel(
        status: json["status"],
...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        slotBookingDetail: SlotBookingDetail.fromJson(json["slot_booking_detail"]??{}),
    );
...
class SlotBookingDetail {
    ...
    factory SlotBookingDetail.fromJson(Map<String, dynamic> json) => SlotBookingDetail(
        id: json["id"],
